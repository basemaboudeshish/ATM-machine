...
{
	SERVER_OK, DECLINED, SAVING_FAILED, TRANSACTION_NOT_FOUND, ACCOUNT_NOT_FOUND, LOW_BALANCE, BLOCKED_ACCOUNT
}EN_serverError_t;
...
extern ST_accountsDB_t accountRefrence[256];

extern ST_transaction transaction[256];
extern ST_transaction TransactionData;
